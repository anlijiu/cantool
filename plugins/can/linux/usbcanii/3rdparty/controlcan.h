...
//5.定义初始化CAN的数据类型
//Timing0 和 Timing1 用来设置 CAN 波特率
// | CAN 波特率 | 定时器 0 | 定时器 1 |
// | ---------- | -------- | -------- |
// |    5Kbps   |   0xBF   |   0xFF   |
// |   10Kbps   |   0x31   |   0x1C   |
...
DWORD VCI_SetReference2(DWORD DevType,DWORD DevIndex,DWORD CANIndex,DWORD RefType,BYTE *pData);

DWORD VCI_ConnectDevice(DWORD DevType,DWORD DevIndex);
DWORD VCI_UsbDeviceReset(DWORD DevType,DWORD DevIndex,DWORD Reserved);
DWORD VCI_FindUsbDevice(PVCI_BOARD_INFO1 pInfo);
DWORD VCI_FindUsbDevice2(PVCI_BOARD_INFO2 pInfo);
